...
public class MySqlGenerator {
    public static void main(String[] args) {
        ...
        strategyConfig.setCapitalMode(true)
                ...
                .setInclude("role_permission", "role_user", "sys_permission", "sys_role", "sys_user")
        ...
        dataSourceConfig.setDbType(DbType.MYSQL)
                ...
                .setUrl("jdbc:mysql://rm-m5ee476bu350735gjeo.mysql.rds.aliyuncs.com:3306/db_hy?useUnicode=true&characterEncoding=utf8&useSSL=false&autoReconnect=true")
                .setUsername("root")
                .setPassword("XuNiit_#");
